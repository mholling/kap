...
OBJECTS    = main.o i2c.o serial.o magnetometer.o app.o scheduler.o timer.o accelerometer.o analog.o spi.o shift_register.o gyros.o estimate_attitude.o timed_section.o
