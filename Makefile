...
OBJECTS    = main.o app.o scheduler.o serial.o timer.o i2c.o calibrate_task.o diagnostic_task.o eeprom.o accelerometer.o analog.o gyros.o spi.o shift_register.o motors.o attitude.o pwm.o
