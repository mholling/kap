...
OBJECTS    = main.o app.o scheduler.o serial.o timer.o i2c.o magnetometer.o calibrate_task.o diagnostic_task.o eeprom.o interrupt_driven.o accelerometer.o analog.o gyros.o spi.o shift_register.o motors.o attitude.o pwm.o
